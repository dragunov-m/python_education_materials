Оригинальная статья: https://habr.com/ru/articles/782266/
...
- `\d+(?!ABC)` - это будет соответствовать символу(-ам), предшествующему `(?!ABC)`, только если за ним _не_ следует `ABC`. Часть `ABC` не будет включена в массив совпадений. Часть `\d` - это всего лишь пример. Это может быть любая строка регулярного выражения.
...
- [Полный список вопросов с собеседований по Python для дата-сайентистов.](https://uproger.com/polnyj-spisok-voprosov-s-sobesedovanij-po-python-dlya-data-sajentistov/)
    
- [Python вопросы с собеседований телеграм канал](https://t.me/+oX5fTaI2eG9mNTli)
    
- [Папка с каналами для Python разработчиков](https://t.me/addlist/8vDUwYRGujRmZjFi)
    
- [Ядро планеты Python. Интерактивный учебник](https://habr.com/ru/articles/728568/)
    
- [Полный список вопросов с собеседований по Python для дата-сайентистов и инженеров](https://habr.com/ru/companies/vk/articles/506824/)
    
- [Обширный обзор собеседований по Python. Советы и подсказки](https://habr.com/ru/articles/439576/)
    
- [Вопросы не мальчика, а джуна. 22 вопроса работодателю на собеседовании на позицию «Middle Python-разработчик»](https://habr.com/ru/articles/428283/)
    
- [Шпаргалка для технического собеседования](https://habr.com/ru/companies/vk/articles/350326/)
    
- [Нейронные сети, машинное обучение, python](https://t.me/+IqWHhio2rrc2YzEy)
    
- [Каверзные вопросы по Python](https://habr.com/ru/companies/domclick/articles/525994/)
    
- [10 проектов с кодом на Python для начинающих](https://uproger.com/10-proektov-na-python-dlya-nachinayushhih/)
